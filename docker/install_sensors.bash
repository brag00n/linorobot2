...
function install_ydlidar {
    echo "=== Download YDLidat-SDK"
    cd /tmp
    git clone https://github.com/YDLIDAR/YDLidar-SDK.git
    mkdir YDLidar-SDK/build
    cd YDLidar-SDK/build
    echo "=== cmake YDLidat-SDK"
    cmake ..
    make
    sudo make install
    cd $WORKSPACE
    echo "=== Download YDLidat"
    ...
    echo "=== Build YDLidat"
    rm -R /root/linorobot2_ws/build/micro_ros_msgs/ament_cmake_python/micro_ros_msgs/micro_ros_msgs
    colcon build --symlink-install
    source $WORKSPACE/install/setup.bash
    echo "=== END YDLidat install"
}
