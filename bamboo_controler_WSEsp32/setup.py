...
package_name = "bamboo_controler_WSEsp32"

setup(
    name=package_name,
    version="0.1.0",
    # Liste VIDE et c'est voulu : ce module n'apporte aucun code Python. Le driver vit dans bamboo_base.
    ...
    description="Enveloppe ROS2 du driver WaveShare ESP32 (bamboo_base) + capacites declarees.",
    license="Apache 2.0",
